...
sealed class IssueEvent {
    ...
    /** Used by [ai.openclaw.jarvis.githubissues.dedupe.IssueDeduplicator] for fingerprinting. */
    ...
    data class OpenClawFailure(
        ...
        override val severity: Severity =
            if (mode == Mode.MALFORMED_RESPONSE || mode == Mode.CONTRACT_VIOLATION
                || mode == Mode.CONNECTION_FAILURE) Severity.ERROR
