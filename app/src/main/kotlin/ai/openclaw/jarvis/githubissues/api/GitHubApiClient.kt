...
/**
 * Thin wrapper around the GitHub REST API. We use the JDK HttpURLConnection
 * (already pulled into the app via java.net) so this module's REST path is
 * synchronous and easy to test, independent of the Ktor WebSocket client
 * used for OpenClaw.
 *
 ...
 */
@Singleton
open class GitHubApiClient @Inject constructor(
