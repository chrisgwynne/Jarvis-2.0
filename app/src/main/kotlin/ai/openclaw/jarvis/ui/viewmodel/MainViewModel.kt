...
import ai.openclaw.jarvis.voice.ListeningModeController
...
class MainViewModel @Inject constructor(
    ...
    val listeningMode: StateFlow<ListeningMode>               = listeningModeController.mode
    ...
    val lastFailure: StateFlow<ConnectionFailure?> = gatewayClient.lastFailure
    ...
    fun setListeningActive()  = listeningModeController.setActive()
    fun setListeningSilent()  = listeningModeController.setSilent()
    fun setListeningStopped() = listeningModeController.setStopped()
    fun pauseListening10Min() = listeningModeController.setPaused(10 * 60 * 1000L)
    fun pauseListening1Hour() = listeningModeController.setPaused(60 * 60 * 1000L)
