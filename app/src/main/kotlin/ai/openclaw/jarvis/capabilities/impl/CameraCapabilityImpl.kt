...
interface CameraCapability : Capability {
    /**
     * Creates a content URI suitable for FileProvider, plus the backing file.
     * The returned Pair.first is the content URI to pass to
     * [buildTakePhotoIntent]; Pair.second is the file to read after capture.
     */
